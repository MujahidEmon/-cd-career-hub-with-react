    ...
    <div className=" bg-base-100   border border-gray-300 rounded-xl">
      ...
      <div className="card-body gap-y-3">
        ...
        <div className="flex gap-2">
            <p className="border-2 rounded px-3 max-w-max font-medium text-blue-400 border-blue-400">{remote_or_onsite}</p>
            <p className="border-2 rounded px-3 max-w-max font-medium text-blue-400 border-blue-400">{job_type}</p>
        </div>
        <div className="flex gap-4">
            ...
            <div className="flex items-center gap-1">
                ...
                <p className="text-left font-semibold text-[#757575]">Salary: {salary}</p>
            </div>
        </div>
        <div className="card-actions">
          <button  className="btn hover:text-black bg-blue-400 text-white font-extrabold">View Details</button>
        </div>
      </div>
    </div>
  );
